...
# ======================================================================================
# ABLATION VARIANT B: WITH image history + subtask-as-input.  (2-GPU, from scratch.)
#
...
#
#   * --image_history True    -> the top-down image is the FULL strided cam_high HISTORY
#                                video (10 frames, stride 10). Input = history video + wrist(t).
...
#
# Variant A (train_action_expert_4b_2gpu_varA_nohist.sh) is identical but --image_history False.
#
...
#   CUDA_VISIBLE_DEVICES=1 NPROC_PER_NODE=1 MASTER_PORT=21002 ./this.sh
...
OUTPUT_DIR="/iris/projects/humanoid/ke/Qwen3-VL/checkpoints/qwen3_4b_ae_hist_subin"
...
RUN_NAME="qwen3vl_4b_ae_hist_subin_bs32"
...
args=(
    ...
    --num_frames 10
    --frame_stride 10
    --image_history True           # <-- VARIANT B: full strided cam_high history video
    --active_dims "7:14"
    --action_dim 7
    --delta_mask "6,-1"
    --action_horizon 50
